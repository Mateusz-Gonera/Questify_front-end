...
//                <button className={style.difficultyIcon} onClick={handleDifficultyChange} />
//             </div>
...
// <h2 className={isChallenge ? style.challengeName : style.taskName} onClick={handleEditTitle}>{titleValue}</h2>
//          )}
//          <div className={style.groupContainer}>
//             <div className={style.groupLabel}>Group:</div>
//             {/* rome-ignore lint/a11y/useKeyWithClickEvents: <explanation> */}
// <div className={style.groupName} onClick={() => setSelectedGroup(group)}> {selectedGroup} </div>
//             <button className={style.groupIcon} onClick={() => setSelectedGroup(group)} />
//             <select className={style.groupSelect} value={selectedGroup} onChange={handleGroupChange}>
